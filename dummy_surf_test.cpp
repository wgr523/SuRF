...
#include "dummy_include/surf.hpp"
#include "dummy_include/dummy_surf.hpp"

using namespace surf;

void LookUpKeyTest(DummySurf* surf, const std::string& key, bool ans){
...
void LookUpRangeTest(DummySurf* surf, const std::string& left_key, const bool left_inclusive, 
...
int main() {
    ...
    DummySurf* surf = new DummySurf(keys,4,&mainMemory);
